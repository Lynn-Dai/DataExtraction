...
if __name__ == '__main__':
    repo_path = "E:\\ASE\\test_projects\\CalyxOS\\base"
    start_commit = '5870093533eb178488e36c465e84466864420947'
    end_commit = '08ac2045945ab3614eca8c95df76d172c576c005'
    # test_commit(repo_path, start_commit, end_commit)
    dump_metric_dict(test_metrics(repo_path, start_commit, end_commit), "metrics.csv")
    # get_depo(repo_path)
