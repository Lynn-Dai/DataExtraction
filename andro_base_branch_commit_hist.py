...
def commit_history_extract():
    base_dir = '/data1/ENRE/dyt/DataExtraction/CustomizedAndroid/platforms/LA/base'
    branch_all = '/data1/ENRE/dyt/DataExtraction/CustomizedAndroid/history/LA/branch_all.txt'
    out_dir = '/data1/ENRE/dyt/DataExtraction/CustomizedAndroid/history/LA/branches'
    with open(branch_all) as f:
        lines = [line.strip() for line in f.readlines()]
    pwd = os.getcwd()
    os.chdir(base_dir)
